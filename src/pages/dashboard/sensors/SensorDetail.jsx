  ...
  return (
    <div>
      <div className="bg-white  overflow-hidden rounded-[16px] shadow-dashboard">
        ...
        <h4 className="m-5 text-[14px] xl:text-[16px] font-[700] ">DS18B20 Temperature Sensor Module For Arduino</h4>
        <div className="p-7">
          <section className="grid grid-cols-12 gap-4 items-start">
            <div className=" col-span-12 xl:col-span-4">
              <section className="mb-3 text-[14px] xl:text-[16px] font-[700] ">SENSOR SPECIFICATION</section>
              {temperatureSpecification.map((specs, i) => (
                <div key={i}>
                  <TemperatureSpecification type="Supply Voltage(V)" status={specs.voltage} />
                  <TemperatureSpecification type="Temperature Range(C)" status={specs.temperature} />
                  <TemperatureSpecification type="Measuring Accuracy(C)" status={specs.accuracy} />
                  <TemperatureSpecification type="Resolution" status={specs.resolution} />
                </div>
              ))}
            </div>
