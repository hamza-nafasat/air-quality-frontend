  ...
  return (
    <div className="flex flex-col gap-2 w-full">
      ...
      <div className="relative w-full" ref={dropdownRef}>
        <button
          type="button"
          className="w-full bg-white border border-primary-lightGray flex items-center justify-between rounded-[12px] h-[50px] md:h-[55px] p-4 text-sm md:text-base text-[#11111199]"
